        ...
        @if(count($selectedAccounts) == 0)
            <div wire:key="filters-box" x-data="{ showAdvanced: false }" class="bg-zinc-900/40 border border-zinc-800/80 p-4 md:p-5 rounded-3xl shadow-sm transition-all">
                ...
                <div :class="showAdvanced ? 'grid' : 'hidden md:grid'" class="grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 mt-4 pt-4 border-t border-zinc-800/50">
                    ...
                    ">
                        <input x-ref="dateFrom" wire:model="filterDateFrom" type="text" readonly placeholder="ثبت از تاریخ" class="w-full bg-zinc-950 border border-zinc-800 text-zinc-300 text-xs rounded-xl p-3 focus:ring-1 focus:ring-orange-500 font-mono text-center cursor-pointer">
                    </div>
                    ...
                    ">
                        <input x-ref="dateTo" wire:model="filterDateTo" type="text" readonly placeholder="ثبت تا تاریخ" class="w-full bg-zinc-950 border border-zinc-800 text-zinc-300 text-xs rounded-xl p-3 focus:ring-1 focus:ring-orange-500 font-mono text-center cursor-pointer">
                    </div>
