<header class="h-24 sticky top-0 z-30 bg-zinc-950/80 backdrop-blur-xl border-b border-zinc-800/80 flex items-center justify-between px-6 lg:px-10">
    ...
    <div class="flex items-center gap-4 sm:gap-6">
        <div class="hidden md:flex relative">
            <input type="text" class="w-64 bg-zinc-900 border border-zinc-800 text-zinc-300 text-sm rounded-xl focus:ring-orange-500 focus:border-orange-500 block pl-10 p-2.5 shadow-inner placeholder-zinc-600 transition" placeholder="جستجو در کاربران و سرورها...">
